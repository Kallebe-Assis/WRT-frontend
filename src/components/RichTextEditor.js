    ...
    <EditorContainer>
      <Editor
        ...
        init={{
          ...
          toolbar: 'undo redo | fontfamily fontsize | bold italic underline strikethrough | forecolor backcolor | link image | table | codesample | align lineheight | numlist bullist indent outdent | checklist texttochecklist | removeformat',
          content_style: `
            body { 
            ...
            .checklist-item.completed .simple-checkbox {
              opacity: 0.8;
            }
          `,
          ...
          setup: (editor) => {
            ...
            // Adicionar comando personalizado para checklist
